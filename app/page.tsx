...
const translations = {
  en: {
    ...
    donateFood: 'Donate Food', findFood: 'Find Food', howItWorks: 'How It Works',
    ...
    signInHeader: 'Sign in to your account', emailLabel: 'Email address', passwordLabel: 'Password',
    selectRolePlaceholder: 'Select Role', roleDonor: 'Donor (Restaurant/Supermarket)', roleNgo: 'NGO / Shelter', roleAdmin: 'Admin',
    signInButton: 'Sign in', signingInButton: 'Signing in...', noAccount: "Don't have an account? Register here.",
  ...
  hi: {
    ...
    donateFood: 'भोजन दान करें', findFood: 'भोजन खोजें', howItWorks: 'यह कैसे काम करता है',
    ...
    signInHeader: 'अपने खाते में साइन इन करें', emailLabel: 'ईमेल पता', passwordLabel: 'पासवर्ड',
    selectRolePlaceholder: 'भूमिका चुनें', roleDonor: 'दाता', roleNgo: 'NGO', roleAdmin: 'एडमिन',
    signInButton: 'साइन इन करें', signingInButton: 'साइन इन हो रहा है...', noAccount: 'खाता नहीं है? यहां पंजीकरण करें।',
  ...
  mr: {
    ...
    donateFood: 'अन्न दान करा', findFood: 'अन्न शोधा', howItWorks: 'हे कसे कार्य करते',
    ...
    signInHeader: 'तुमच्या खात्यात साइन इन करा', emailLabel: 'ईमेल पत्ता', passwordLabel: 'पासवर्ड',
    selectRolePlaceholder: 'भूमिका निवडा', roleDonor: 'दाता', roleNgo: 'NGO', roleAdmin: 'ऍडमिन',
    signInButton: 'साइन इन करा', signingInButton: 'साइन इन करत आहे...', noAccount: 'खाते नाही? येथे नोंदणी करा.',
        ...
        {toasts.map(toast => (
          ...
          >
            <div className="flex items-center">
              <span className="font-medium">{toast.type === 'success' ? '✓' : '✗'}</span>
...
// === ICONS ===
const Globe = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 mr-2"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>;
const Menu = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>;
const X = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>;
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        {(navLinks[user?.role] || navLinks.null).map(link => ( 
                          <a 
                            ...
                            className="text-gray-600 hover:text-indigo-600 transition duration-150 ease-in-out relative group"
                          >
                            {link.name}
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        {user ? ( 
                          <button 
                            ...
                            className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:from-red-600 hover:to-orange-600 transition-all shadow-md hover:shadow-lg transform hover:scale-105 duration-300"
                          >
                            {t('logout')}
                          </button>
                        ) : ( 
                ...
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                  ...
                  {user ? ( 
                    <a 
                      ...
                      className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-white hover:bg-red-500 transition-colors duration-300"
                    >
                      {t('logout')}
                    </a>
                  ) : ( 
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                  ...
                  <div className="grid md:grid-cols-3 gap-8 text-center">
                    <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl">
          ...
          locations.forEach(loc => { 
            if (loc.location) { 
              L.marker([loc.location.lat, loc.location.lng])
                .addTo(map.current)
                .bindPopup(`<b>${loc.donor}</b><br>${loc.type}`)
                .openPopup(); 
            } 
          }); 
        } 
...
const ListingsPage = ({donations, user}) => {
    const { t } = useTranslation();
    ...
    const handleClaim = async (donationId) => { 
      if(user.role !== 'ngo'){
        addToast(t('donationError'), 'error');
        return;
      }
      ...
      try {
        ...
        addToast(t('donationClaimed'), 'success');
      } catch (error) {
    ...
    return ( 
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6">{t('availableFood')}</h1>
        {isLoading ? ( 
          <div className="flex justify-center items-center h-64">
            <Spinner /> 
            <span className="ml-3 text-lg">Loading donations...</span>
          </div>
        ) : ( 
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-1/2 flex flex-col gap-4">
              {donations.filter(d => d.status === 'Available').map(donation => ( 
                <div 
                  key={donation.id} 
                  className="bg-white p-4 rounded-lg shadow-md border flex items-center gap-4 transition-all duration-300 hover:shadow-xl hover:border-indigo-300"
                >
                  <img 
                  ...
                  <div className="flex-grow">
                    <h3 className="font-bold text-lg text-indigo-700">{donation.donor}</h3>
                    <p className="text-gray-600">{donation.type} - {donation.quantity}</p>
                    <p className="text-sm text-gray-500">Expires: {donation.expiry}</p>
                    <p className="text-sm text-gray-500"><MapPin /> Mumbai</p>
                  </div>
                  <button 
                    onClick={() => handleClaim(donation.id)} 
                    className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition-colors duration-300 disabled:bg-gray-400 transform hover:scale-105"
            ...
            <div className="lg:w-1/2 rounded-lg overflow-hidden shadow-lg">
              <LeafletMap locations={donations.filter(d => d.status === 'Available')} />
            </div>
          </div>
        )} 
      </div>
...
// Revamped Login/Register Component
const Login = ({ setUser, setPage }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
            <div className="relative w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up">
                {/* Image Panel */}
                <div className="w-full md:w-1/2 hidden md:block relative">
                    <img
                        src="https://images.unsplash.com/photo-1593113589675-74b59523c913?auto=format&fit=crop&w=800&q=80"
                        alt="Community food sharing"
                        className="w-full h-full object-cover"
                    />
                     <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                      <div className="absolute bottom-8 left-8 text-white p-4">
                        <h2 className="text-3xl font-bold">{t('authWelcome')}</h2>
                        <p className="mt-2 text-lg italic">{t('authQuote')}</p>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    <h2 className="text-3xl font-bold text-gray-800 mb-4">
                      {isLoginView ? t('signInHeader') : t('registerHeader')}
                    </h2>
                    <form className="space-y-6" onSubmit={handleAuthAction}>
                        <div>
                            ...
                            <input 
                              ...
                              type="email" 
                              required 
                              className="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-colors duration-300" 
                        ...
                        {!isLoginView && (
                            <div>
                                ...
                                <select 
                                  ...
                                  required 
                                  className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md transition-colors duration-300"
                                >
                        ...
                        {error && <p className="text-red-500 text-sm text-center bg-red-50 p-2 rounded-md animate-pulse">{error}</p>}
                        
                        <div>
                            <button 
                              type="submit" 
                              disabled={isLoading} 
                              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-indigo-400 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-[1.02]"
                            >
                                {isLoading && <Spinner />}
                                {isLoading ? (isLoginView ? t('signingInButton') : t('registeringButton')) : (isLoginView ? t('signInButton') : t('registerButton'))}
                            </button>
                        </div>
...
const DonorDashboard = ({ user, donations }) => {
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold">{t('welcomeDonor')}</h1>
...
const DonationViewModal = ({ donation, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4 animate-fade-in">
            <div className="bg-white rounded-lg shadow-2xl max-w-lg w-full transform transition-all animate-fade-in-up">
                <div className="p-6">
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-gray-600">from <span className="font-medium">{donation.donor}</span></p>
...
const NGODashboard = ({donations, user}) => { 
    const claimedByMe = donations?.filter(d => d.claimedBy === user.uid) || [];
    const { t } = useTranslation();
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
                ...
                <div>
                    <h1 className="text-3xl font-bold">{t('welcomeNgo')}</h1>
                    <p className="text-gray-600">{userName}</p>
                </div>
            </div>
            <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-gray-700">Total Donations</h3>
            <p className="text-3xl font-bold text-indigo-600 mt-2">{donations?.length || 0}</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
...
const DonationForm = ({ setPage, user }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            addToast('Error submitting donation. Please try again.', 'error');
        }
    };
            ...
            {submitStatus === 'success' ? ( 
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-indigo-400 transition-colors duration-300">
                ...
                <div className="flex justify-end space-x-4">
                  <button 
                    ...
                    className="bg-gray-200 text-gray-800 px-6 py-2 rounded-md font-medium hover:bg-gray-300 transition-colors duration-300"
                  >
                    {t('cancel')}
                  </button>
                  <button 
                    ...
                    className="bg-indigo-600 text-white px-6 py-2 rounded-md font-medium hover:bg-indigo-700 flex items-center justify-center disabled:bg-indigo-400 transition-all duration-300 transform hover:scale-105"
                  >
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-6">{t('aboutTitle')}</h1>
...
const ContactPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-6">{t('contactTitle')}</h1>
            ...
            <div className="md:w-1/2 p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full bg-indigo-600 text-white py-3 px-4 rounded-md font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-indigo-400 transition-all duration-300 transform hover:scale-[1.02]"
                >
                  {isSubmitting ? (
    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="container mx-auto py-8 px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-2">FoodSave</h3>
            <p className="text-gray-400">Reducing food waste and fighting hunger in Mumbai.</p>
          </div>
          <div>
...
export default function App() {
    ...
    const renderPage = () => {
        ...
        switch (page) {
            ...
            case 'listings': return user ? <ListingsPage donations={donations} user={user} /> : <Login setUser={setUser} setPage={setPage} />;
            case 'login': return <Login setUser={setUser} setPage={setPage} />;
            case 'donorDashboard': return user?.role === 'donor' ? <DonorDashboard user={user} donations={donations} /> : <Login setUser={setUser} setPage={setPage} />;
            case 'ngoDashboard': return user?.role === 'ngo' ? <NGODashboard donations={donations} user={user} /> : <Login setUser={setUser} setPage={setPage} />;
